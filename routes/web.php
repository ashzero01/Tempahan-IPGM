...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('vehicle/bookings/{timestamp}/{destination}/approve', [VehicleBookingController::class, 'approveGroupedBookings'])
    ->name('vehicle.bookings.approve');
    Route::post('vehicle/bookings/{timestamp}/{destination}/reject', [VehicleBookingController::class, 'rejectGroupedBookings'])
    ->name('vehicle.bookings.reject');
    ...
    Route::delete('/user/vehicle-bookings/group/{timestamp}/{destination}', [VehicleBookingController::class, 'deleteGroupedBookings'])
    ->name('vehicle.bookings.delete.group');
