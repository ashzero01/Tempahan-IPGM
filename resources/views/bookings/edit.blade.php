...
.highlighted-row {
    background-color: #ffffcc !important;
        ...
        /* Reuse the styles from create.blade.php */
        table {
            width: 100%;
...
<a href="{{ route('dashboard') }}">Halaman Utama</a>
                        ...
                        <div class="form-container">
                            <form action="{{ route('bookings.store', ['room' => $room->id]) }}" method="POST">
                                ...
                                <div style="display: flex; align-items: center;">
                                    <input type="time" id="start_time" name="start_time" style="margin-right: 10px;" value="{{ old('start_time', $booking->start_time ?? '') }}" required>
                                    <span>sehingga</span>
                                    <input type="time" id="end_time" name="end_time" style="margin-left: 10px;" value="{{ old('end_time', $booking->end_time ?? '') }}" required>
                                    @error('start_time')
                                    <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                    @error('end_time')
                                ...
                                <div>
                                    ...
                                    <input type="text" id="purpose" name="purpose" value="{{ old('purpose', $booking->purpose ?? '') }}" required>
                                </div>
    ...
    fetch(endpoint)
        ...
        .then(bookings => {
            ...
            bookings.forEach(booking => { // Use bookings instead of filteredBookings
